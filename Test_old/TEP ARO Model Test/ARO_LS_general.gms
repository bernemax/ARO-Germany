...
$setGlobal General_LS                 "*"          if "*"  no general Load sheadding is applied, if "" general LS is apllied
;
...
z_PG_Ren_10(rr,DF)           decision variable to construct polyhedral UC-set and decides weather combined pv and wind generation potential is Max or not
z_PG_Ren_20(rr,t)
z_PG_Ren_30(rr,t)
...
*          Pdem_De(n,t)   =e= Load_unshed(n,t) + delta_load_DE(n,t) * z_dem_De(n,t)
;
SUB_US_LOAD_States(n,t)$(border_states(n))..                        Pdem_States(n,t) =e= Load_states(n,t) + delta_load_states(n,t) * z_dem_states(n,t)
*Pdem_States(n,t) =e= Load_states(n,t) + delta_load_states(n,t) * z_dem_states(n,t)
;
...
SUB_US_PG_RR(rr,ren,n,t,DF)$(Map_RR(rr,ren,n) and Map_DF(t,DF))..     AF_Ren(t,rr,n) =e= af_ren_up(t,rr,n) - delta_af_ren_10(t,rr,n) * z_PG_Ren_10(rr,DF)
;
SUB_UB_Total..                                                       Gamma_Ren_total - sum((rr,DF),  z_PG_Ren_10(rr,DF)) =g= 0
*SUB_UB_Total..                                                       Gamma_Ren_total - sum((rr,t),  z_PG_Ren_10(rr,t) +  z_PG_Ren_20(rr,t) +  z_PG_Ren_30(rr,t)) =g= 0
;
SUB_UB_PG_RR_10(rr)..                                                sum((DF),  z_PG_Ren_10(rr,DF))  =l= Gamma_PG_ren_10(rr)
;
$ontext
...
;
SUB_RR_time_coupling(rr,t)..                                         sum(tt$(ord(tt) <= ord (t) and ord(tt) >= (ord(t) - dark_time)), Start_dunkel(rr,tt)) =l=  z_PG_Ren_10(rr,t) + z_PG_Ren_20(rr,t) + z_PG_Ren_30(rr,t)
;
SUB_RR_Dunkel_start(rr,t)..                                          Start_dunkel(rr,t)   =g=  z_PG_Ren_10(rr,t) - z_PG_Ren_10(rr,t-1)
...
;
*$offtext
SUB_lin17(rr,ren,t,DF)$(RR_Ren(rr,ren) and Map_DF(t,DF))..         aux_phi_PG_Ren_10(ren,t)                             =l= M *  z_PG_Ren_10(rr,DF)
;
SUB_lin18(rr,ren,t,DF)$(RR_Ren(rr,ren) and Map_DF(t,DF))..          phiPG_Ren(ren,t) -  aux_phi_PG_Ren_10(ren,t)         =l= M *  (1 - z_PG_Ren_10(rr,DF))
;
SUB_lin19(rr,ren,t,DF)$(RR_Ren(rr,ren) and Map_DF(t,DF))..          - M * z_PG_Ren_10(rr,DF)                              =l= aux_phi_PG_Ren_10(ren,t)
;
SUB_lin20(rr,ren,t,DF)$(RR_Ren(rr,ren) and Map_DF(t,DF))..          - M * (1 - z_PG_Ren_10(rr,DF) )                       =l= phiPG_Ren(ren,t) -  aux_phi_PG_Ren_10(ren,t)
;
...
*%Summed_Wind_PV%SUB_RR_Dunkel_start
...
execute_unload "Loop_Run_General_LS.gdx";
;
)
