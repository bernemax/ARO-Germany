...
*aux_PG(g,t)         aux continuous var to linearize phiPG(g,t) * PE(g,t) in SUB Objective
*aux_LS(n,t)         aux continuous var to linearize phiLS(n,t) * Pdem(n,t) in SUB Objective
;
...
;
MP_PF_PROS_LIN_UB(l,t,vv)$(pros_l(l) and (ord(vv) lt (itaux+1)))..  (1-inv_M(l)) *M   =g= PF_M(l,t,vv) - (1/line_data(l,'react') * (sum(n$Map_prosp_Send(l,n),  Theta(n,t,vv)) - sum(n$Map_prosp_Send(l,n),  Theta(n,t,vv))))
;
MP_PF_PROS_LIN_LB(l,t,vv)$(pros_l(l) and (ord(vv) lt (itaux+1)))..  -(1-inv_M(l)) *M  =l= PF_M(l,t,vv) - (1/line_data(l,'react') * (sum(n$Map_prosp_Send(l,n),  Theta(n,t,vv)) - sum(n$Map_prosp_Send(l,n),  Theta(n,t,vv))))
;
...
SUB_LIN_Dual_Send(n,t)..                                            sum(l$MapSend_l(l,n), - (1/line_data(l,'react')) * phi(l,t))
                                                                    + sum(l$MapSend_l(l,n), (1/line_data(l,'react')) * beta_UB_lin(l,t))
                                                                    - sum(l$MapSend_l(l,n), (1/line_data(l,'react')) * beta_LB_lin(l,t))
                                                                    -  teta_UB(n,t)
                                                                    +  teta_LB(n,t)                                 =l= 0
;
...
SUB_Lin_Dual_Send_n_ref(n,t)..                                      sum(l$(MapSend_l(l,n) and ref(n)),(1/line_data(l,'react')) * phi(l,t))
                                                                    - sum(l$(MapSend_l(l,n) and ref(n)), (1/line_data(l,'react')) * beta_UB_lin(l,t))
                                                                    + sum(l$(MapSend_l(l,n) and ref(n)), (1/line_data(l,'react')) * beta_LB_lin(l,t)) 
                                                                    -  teta_UB(n,t)
                                                                    +  teta_LB(n,t)
                                                                    +  teta_ref(n,t)     =e= 0                                                                    
$ontext
...
SUB_Lin_Dual_Res_n_ref(n,t)..                                       sum(l$(MapRes_l(l,n) and ref(n)),(1/line_data(l,'react')) * phi(l,t))
                                                                    - sum(l$(MapRes_l(l,n) and ref(n)), (1/line_data(l,'react')) * beta_UB_lin(l,t))
                                                                    + sum(l$(MapRes_l(l,n) and ref(n)), (1/line_data(l,'react')) * beta_LB_lin(l,t)) 
                                                                    - teta_UB(n,t)
                                                                    + teta_LB(n,t)
                                                                    + teta_ref(n,t)      =e= 0
;
...
$ontext
SUB_lin1..                                                          - M * sum((n,t), lam(n,t))      =l= aux_lam(n,t)
;
SUB_lin2..                                                          aux_lam(n,t)                    =l= M * sum((n,t), lam(n,t))
;
SUB_lin3..                                                          - (1 - sum((n,t), lam(n,t)))    =l= 
;
SUB_lin4..
;
