...
Curtailment(res,t,v)        Curtailment of renewable infeed
...
SUB_Dual_Objective..                                                O_Sub =e= sum((n,t), lam(n,t) * load(n,t) 
                                                                    ...
                                                                    + sum((l,t), - omega_UB(l,t) *  L_cap(l))
                                                                    + sum((l,t), - omega_LB(l,t) *  L_cap(l))
...
;
*SUB_Dual_Curtail(res,t)..                                           sum((sun,wind) ,   phiPG_PV(sun,t) +  phiPG_Wind(wind,t))               =l=   cur_costs
*;
...
SUB_Dual_PF(l,t)..                                                  - sum(n$(Map_Send_l(l,n) and ex_l(l)), lam(n,t)) + sum(n$(Map_Res_l(l,n) and ex_l(l)), lam(n,t))
                                                                    - omega_UB(l,t)  + omega_LB(l,t) + phi(l,t)
                                                                                                                      =e= 0
;
SUB_LIN_Dual(n,t)..                                                 - sum(l$(Map_Send_l(l,n) and ex_l(l) and not ref(n)),  B_prosp_380(l) * phi(l,t))
                                                                    + sum(l$(Map_Res_l(l,n) and ex_l(l) and not ref(n)),   B_prosp_380(l) * phi(l,t))
                                                                    -  teta_UB(n,t)
                                                                    +  teta_LB(n,t)                                   =e= 0
;
SUB_Lin_Dual_n_ref(n,t)..                                           - sum(l$(Map_Send_l(l,n) and ex_l(l) and ref(n)),  B_prosp_380(l)  * phi(l,t))
                                                                    + sum(l$(Map_Res_l(l,n) and ex_l(l) and ref(n)),   B_prosp_380(l)  * phi(l,t))
